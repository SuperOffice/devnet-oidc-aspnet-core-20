...
using SuperOffice.DevNet.NetCoreExample.Models.AccountViewModels;
using SuperOffice.DevNet.NetCoreExample.Services;

namespace SuperOffice.DevNet.NetCoreExample.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            string idToken      = info.AuthenticationTokens.FirstOrDefault(t => t.Name == "id_token").Value;
